...
Implementation for [PerfectScrollbar](https://perfectscrollbar.com/)
...
```javascript
import { PerfectScrollbarModule } from 'mcu-perfect-scrollbar';
import { PERFECT_SCROLLBAR_CONFIG } from 'mcu-perfect-scrollbar';
import { PerfectScrollbarConfigInterface } from 'mcu-perfect-scrollbar';
