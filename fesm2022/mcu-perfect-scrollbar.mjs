...
import { Subject, fromEvent, auditTime, takeUntil, merge, map } from 'rxjs';
import { takeUntil as takeUntil$1, distinctUntilChanged } from 'rxjs/operators';
...
class PerfectScrollbarComponent {
    ...
    ngOnInit() {
        if (isPlatformBrowser(this.platformId)) {
            this.stateUpdate
                .pipe(takeUntil$1(this.ngDestroy), distinctUntilChanged((a, b) => (a === b && !this.stateTimeout)))
                .subscribe((state) => {
            ...
            this.zone.runOutsideAngular(() => {
                if (this.directiveRef) {
                    ...
                    fromEvent(element, 'wheel')
                        .pipe(takeUntil$1(this.ngDestroy))
                        .subscribe((event) => {
...
class PerfectScrollbarModule {
    ...
    static { this.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "16.1.3", ngImport: i0, type: PerfectScrollbarModule, declarations: [PerfectScrollbarComponent, PerfectScrollbarDirective, ForceNativeScrollDirective], exports: [PerfectScrollbarComponent, PerfectScrollbarDirective, ForceNativeScrollDirective] }); }
    static { this.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "16.1.3", ngImport: i0, type: PerfectScrollbarModule }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.1.3", ngImport: i0, type: PerfectScrollbarModule, decorators: [{
            ...
            args: [{
                    ...
                    imports: [],
                    exports: [PerfectScrollbarComponent, PerfectScrollbarDirective, ForceNativeScrollDirective],
                }]
        }] });
...
export { ForceNativeScrollDirective, Geometry, PERFECT_SCROLLBAR_CONFIG, PerfectScrollbarComponent, PerfectScrollbarConfig, PerfectScrollbarDirective, PerfectScrollbarEvents, PerfectScrollbarModule, Position };
//# sourceMappingURL=mcu-perfect-scrollbar.mjs.map
